...
beautiful.init("/home/lugp/.dotfiles/.config/awesome/mytheme.lua")
...
awful.layout.layouts = {
  ...
  -- awful.layout.suit.corner.ne, awful.layout.suit.corner.sw,
...
globalkeys = gears.table.join(
  ...
  awful.key({}, "XF86AudioLowerVolume", function() awful.spawn("pactl set-sink-volume @DEFAULT_SINK@ -5%") end,
    { description = "more volume", group = "client" }),
  ...
  -- Screenshots
  awful.key({ modkey, }, "s", function() awful.spawn("scrot -e 'mv $f ~/Pictures/Screenshots/'") end,
    { description = "more volume", group = "client" }),

  -- Redshift
  awful.key({ modkey, }, "r", function() awful.spawn("redshift -O 2400") end,
    { description = "more volume", group = "client" }),
  awful.key({ modkey, "Shift" }, "r", function() awful.spawn("redshift -x") end,
    { description = "more volume", group = "client" }),

  -- Keyboard
  awful.key({ modkey }, "space", function() awful.spawn("setxkbmap latam") end,
    { description = "more volume", group = "client" }),
  awful.key({ modkey, "Shift" }, "space", function() awful.spawn("setxkbmap us") end,
    { description = "more volume", group = "client" })
)
